...
Scalar-based signing is in progress. A matching discovery tag identifies a candidate; the recipient must check the destination authority before accepting a payment.
...
- `sha2` — SHA-2 hashing for discovery tags and scalar tweaks.
